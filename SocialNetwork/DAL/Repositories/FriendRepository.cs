...
/// <summary>
/// Этот класс обеспечивает доступ к данным, а также  операции
/// добавления, удаления и получения информации о друзьях пользователей.
/// Он инкапсулирует логику доступа к данным о дружеских связях, обеспечивая
/// согласованный интерфейс для работы с этими данными в рамках приложения.
/// FriendRepository взаимодействует с базой данных или другим хранилищем для
/// сохранения и получения информации о друзьях пользователя.
/// </summary>
